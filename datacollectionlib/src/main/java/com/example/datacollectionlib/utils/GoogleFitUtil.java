package com.example.datacollectionlib.utils;
...
public class GoogleFitUtil {
    ...
    * */
    ...
    public static void getDeviceDetails(DataType dataType, GoogleSignInAccount googleSignInAccount, AppCompatActivity activity){
        Fitness.getSensorsClient(activity,googleSignInAccount).findDataSources(
                new DataSourcesRequest.Builder().setDataTypes(dataType).setDataSourceTypes(DataSource.TYPE_RAW).build()
            ...
            public void onFailure(@NonNull Exception e) {
                Log.e(TAG, "getSensorClient " + e.getLocalizedMessage());
            }
        });
    }
    ...
    public static void unSubscribe(DataType dataType, GoogleSignInAccount googleSignInAccount, AppCompatActivity activity){
        Fitness.getRecordingClient(activity, googleSignInAccount).unsubscribe(dataType)
